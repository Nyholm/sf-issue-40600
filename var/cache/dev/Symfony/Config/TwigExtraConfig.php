...
class TwigExtraConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    public function html(array $value = []): \Symfony\Config\TwigExtra\HtmlConfig
    {
        if (null === $this->html) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "html()" has already been initialized. You cannot pass values the second time you call html().'));
        }
    ...
    public function markdown(array $value = []): \Symfony\Config\TwigExtra\MarkdownConfig
    {
        if (null === $this->markdown) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "markdown()" has already been initialized. You cannot pass values the second time you call markdown().'));
        }
    ...
    public function intl(array $value = []): \Symfony\Config\TwigExtra\IntlConfig
    {
        if (null === $this->intl) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "intl()" has already been initialized. You cannot pass values the second time you call intl().'));
        }
    ...
    public function cssinliner(array $value = []): \Symfony\Config\TwigExtra\CssinlinerConfig
    {
        if (null === $this->cssinliner) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "cssinliner()" has already been initialized. You cannot pass values the second time you call cssinliner().'));
        }
    ...
    public function inky(array $value = []): \Symfony\Config\TwigExtra\InkyConfig
    {
        if (null === $this->inky) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "inky()" has already been initialized. You cannot pass values the second time you call inky().'));
        }
    ...
    public function string(array $value = []): \Symfony\Config\TwigExtra\StringConfig
    {
        if (null === $this->string) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "string()" has already been initialized. You cannot pass values the second time you call string().'));
        }
