...
class TokenProviderConfig 
{
    ...
    public function doctrine(array $value = []): \Symfony\Config\Security\FirewallConfig\RememberMe\TokenProvider\DoctrineConfig
    {
        if (null === $this->doctrine) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "doctrine()" has already been initialized. You cannot pass values the second time you call doctrine().'));
        }
