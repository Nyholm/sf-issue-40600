...
require_once __DIR__.'/DefaultOptionsConfig/PeerFingerprintConfig.php';
require_once __DIR__.'/DefaultOptionsConfig/RetryFailedConfig.php';
...
class DefaultOptionsConfig 
{
    ...
    public function peerFingerprint(array $value = []): \Symfony\Config\Framework\HttpClientConfig\DefaultOptionsConfig\PeerFingerprintConfig
    {
        if (null === $this->peerFingerprint) {
            $this->peerFingerprint = new \Symfony\Config\Framework\HttpClientConfig\DefaultOptionsConfig\PeerFingerprintConfig($value);
        } elseif ([] !== $value) {
    ...
    public function retryFailed(array $value = []): \Symfony\Config\Framework\HttpClientConfig\DefaultOptionsConfig\RetryFailedConfig
    {
        if (null === $this->retryFailed) {
            $this->retryFailed = new \Symfony\Config\Framework\HttpClientConfig\DefaultOptionsConfig\RetryFailedConfig($value);
        } elseif ([] !== $value) {
