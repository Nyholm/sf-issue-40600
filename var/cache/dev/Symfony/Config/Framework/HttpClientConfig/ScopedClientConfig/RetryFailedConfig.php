...
namespace Symfony\Config\Framework\HttpClientConfig\ScopedClientConfig;
...
class RetryFailedConfig 
{
    ...
    public function httpCode(string $code, array $value = []): \Symfony\Config\Framework\HttpClientConfig\ScopedClientConfig\RetryFailedConfig\HttpCodeConfig
    {
        return $this->httpCodes[$code] = new \Symfony\Config\Framework\HttpClientConfig\ScopedClientConfig\RetryFailedConfig\HttpCodeConfig($value);
    }
