...
class RetryFailedConfig 
{
    ...
    public function httpCode(string $code, array $value = []): \Symfony\Config\Framework\HttpClientConfig\DefaultOptionsConfig\RetryFailedConfig\HttpCodeConfig
    {
        return $this->httpCodes[$code] = new \Symfony\Config\Framework\HttpClientConfig\DefaultOptionsConfig\RetryFailedConfig\HttpCodeConfig($value);
    }
