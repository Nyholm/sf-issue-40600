...
class BusConfig 
{
     ...
     */
    public function defaultMiddleware(string $value): self
    {
    ...
    public function middleware(array $value = []): \Symfony\Config\Framework\MessengerConfig\BusConfig\MiddlewareConfig
    {
        return $this->middleware[] = new \Symfony\Config\Framework\MessengerConfig\BusConfig\MiddlewareConfig($value);
    }
