...
namespace Symfony\Config\Framework\RateLimiterConfig;
...
class LimiterConfig 
{
    ...
    public function rate(array $value = []): \Symfony\Config\Framework\RateLimiterConfig\LimiterConfig\RateConfig
    {
        if (null === $this->rate) {
            $this->rate = new \Symfony\Config\Framework\RateLimiterConfig\LimiterConfig\RateConfig($value);
        } elseif ([] !== $value) {
