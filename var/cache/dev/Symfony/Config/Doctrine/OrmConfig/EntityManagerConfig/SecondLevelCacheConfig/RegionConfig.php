...
namespace Symfony\Config\Doctrine\OrmConfig\EntityManagerConfig\SecondLevelCacheConfig;
...
class RegionConfig 
{
    ...
    public function cacheDriver(array $value = []): \Symfony\Config\Doctrine\OrmConfig\EntityManagerConfig\SecondLevelCacheConfig\RegionConfig\CacheDriverConfig
    {
        if (null === $this->cacheDriver) {
            $this->cacheDriver = new \Symfony\Config\Doctrine\OrmConfig\EntityManagerConfig\SecondLevelCacheConfig\RegionConfig\CacheDriverConfig($value);
        } elseif ([] !== $value) {
