...
namespace Symfony\Config\Doctrine\DbalConfig;
...
class ConnectionConfig 
{
    ...
    public function slave(string $name, array $value = []): \Symfony\Config\Doctrine\DbalConfig\ConnectionConfig\SlaveConfig
    {
        return $this->slaves[$name] = new \Symfony\Config\Doctrine\DbalConfig\ConnectionConfig\SlaveConfig($value);
    }
    
    public function replica(string $name, array $value = []): \Symfony\Config\Doctrine\DbalConfig\ConnectionConfig\ReplicaConfig
    {
        return $this->replicas[$name] = new \Symfony\Config\Doctrine\DbalConfig\ConnectionConfig\ReplicaConfig($value);
    }
    
    public function shard(array $value = []): \Symfony\Config\Doctrine\DbalConfig\ConnectionConfig\ShardConfig
    {
        return $this->shards[] = new \Symfony\Config\Doctrine\DbalConfig\ConnectionConfig\ShardConfig($value);
    }
