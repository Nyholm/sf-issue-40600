...
class TwigConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    public function global(string $key, array $value = []): \Symfony\Config\Twig\GlobalConfig
    {
        ...
        throw new InvalidConfigurationException(sprintf('The node created by "global()" has already been initialized. You cannot pass values the second time you call global().'));
    }
    ...
    public function date(array $value = []): \Symfony\Config\Twig\DateConfig
    {
        if (null === $this->date) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "date()" has already been initialized. You cannot pass values the second time you call date().'));
        }
    ...
    public function numberFormat(array $value = []): \Symfony\Config\Twig\NumberFormatConfig
    {
        if (null === $this->numberFormat) {
            ...
            throw new InvalidConfigurationException(sprintf('The node created by "numberFormat()" has already been initialized. You cannot pass values the second time you call numberFormat().'));
        }
