...
namespace Config\Framework\TranslatorConfig;
...
class PseudoLocalizationConfig
{
     ...
     * @default true
     */
    public function setAccents(bool $value): self
    {
        $this->accents = $value;
     ...
     * @default 1.0
     */
    public function setExpansionFactor(float $value): self
    {
     ...
     * @default true
     */
    public function setBrackets(bool $value): self
    {
        $this->brackets = $value;
     ...
     * @default false
     */
    public function setParseHtml(bool $value): self
    {
    ...
    public function addLocalizableHtmlAttribute( $value): self
    {
