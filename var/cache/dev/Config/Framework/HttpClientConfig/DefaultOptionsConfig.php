...
class DefaultOptionsConfig
{
    ...
    public function addPeerFingerprint(array $value = []): \Config\Framework\HttpClientConfig\DefaultOptionsConfig\PeerFingerprintConfig
    {
        return $this->peerFingerprint = new \Config\Framework\HttpClientConfig\DefaultOptionsConfig\PeerFingerprintConfig($value);
    }
    
    public function addRetryFailed(array $value = []): \Config\Framework\HttpClientConfig\DefaultOptionsConfig\RetryFailedConfig
    {
        return $this->retryFailed = new \Config\Framework\HttpClientConfig\DefaultOptionsConfig\RetryFailedConfig($value);
    }
