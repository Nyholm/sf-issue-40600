...
namespace Config\Framework\HttpClientConfig\ScopedClientConfig;
...
class RetryFailedConfig
{
    ...
    public function addHttpCode(string $code, array $value = []): \Config\Framework\HttpClientConfig\ScopedClientConfig\RetryFailedConfig\HttpCodeConfig
    {
        return $this->httpCodes[$code] = new \Config\Framework\HttpClientConfig\ScopedClientConfig\RetryFailedConfig\HttpCodeConfig($value);
    }
