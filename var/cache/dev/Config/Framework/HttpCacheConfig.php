...
class HttpCacheConfig
{
     ...
     */
    public function setTraceLevel(string $value): self
    {
     ...
     * @default NULL
     */
    public function setTraceHeader( $value): self
    {
     ...
     * @default NULL
     */
    public function setDefaultTtl(int $value): self
    {
    ...
    public function addPrivateHeader( $value): self
    {
     ...
     * @default NULL
     */
    public function setAllowReload(bool $value): self
    {
     ...
     * @default NULL
     */
    public function setAllowRevalidate(bool $value): self
    {
