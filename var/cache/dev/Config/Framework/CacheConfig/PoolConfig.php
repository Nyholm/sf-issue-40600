...
namespace Config\Framework\CacheConfig;
...
class PoolConfig
{
    ...
    public function addAdapter( $value): self
    {
        $this->adapters[] = $value;
     ...
     * @default NULL
     */
    public function setDefaultLifetime( $value): self
    {
     ...
     * @default NULL
     */
    public function setEarlyExpirationMessageBus( $value): self
    {
     ...
     * @default NULL
     */
    public function setClearer( $value): self
    {
        $this->clearer = $value;
