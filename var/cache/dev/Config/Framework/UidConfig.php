...
class UidConfig
{
     ...
     * @param 6|4|1 $value
     */
    public function setDefaultUuidVersion(string $value): self
    {
     ...
     * @param 5|3 $value
     */
    public function setNameBasedUuidVersion(string $value): self
    {
     ...
     * @default NULL
     */
    public function setNameBasedUuidNamespace( $value): self
    {
     ...
     * @param 6|1 $value
     */
    public function setTimeBasedUuidVersion(string $value): self
    {
     ...
     * @default NULL
     */
    public function setTimeBasedUuidNode( $value): self
    {
