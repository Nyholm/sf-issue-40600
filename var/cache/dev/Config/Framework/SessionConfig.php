...
class SessionConfig
{
     ...
     */
    public function setStorageId( $value): self
    {
     ...
     * @default NULL
     */
    public function setStorageFactoryId( $value): self
    {
     ...
     */
    public function setHandlerId( $value): self
    {
     ...
     * @default NULL
     */
    public function setCookieLifetime( $value): self
    {
     ...
     * @default NULL
     */
    public function setCookiePath( $value): self
    {
     ...
     * @default NULL
     */
    public function setCookieDomain( $value): self
    {
     ...
     */
    public function setCookieSecure(string $value): self
    {
     ...
     * @default true
     */
    public function setCookieHttponly(bool $value): self
    {
     ...
     */
    public function setCookieSamesite(string $value): self
    {
     ...
     * @default NULL
     */
    public function setUseCookies(bool $value): self
    {
     ...
     * @default NULL
     */
    public function setGcDivisor( $value): self
    {
     ...
     * @default 1
     */
    public function setGcProbability( $value): self
    {
     ...
     * @default NULL
     */
    public function setGcMaxlifetime( $value): self
    {
     ...
     */
    public function setSavePath( $value): self
    {
        $this->savePath = $value;
     ...
     * @default 0
     */
    public function setMetadataUpdateThreshold(int $value): self
    {
     ...
     * @default NULL
     */
    public function setSidLength(int $value): self
    {
     ...
     * @default NULL
     */
    public function setSidBitsPerCharacter(int $value): self
    {
