...
class DqlConfig
{
    ...
    public function addStringFunction(string $name,  $value): self
    {
    ...
    public function addNumericFunction(string $name,  $value): self
    {
    ...
    public function addDatetimeFunction(string $name,  $value): self
    {
