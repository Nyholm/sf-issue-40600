...
class AccessControlConfig
{
     ...
     * @default NULL
     */
    public function setRequiresChannel( $value): self
    {
    ...
    public function addIp( $value): self
    {
        $this->ips[] = $value;
    ...
    public function addMethod( $value): self
    {
        $this->methods[] = $value;
     ...
     * @default NULL
     */
    public function setAllowIf( $value): self
    {
        $this->allowIf = $value;
    ...
    public function addRole( $value): self
    {
        $this->roles[] = $value;
