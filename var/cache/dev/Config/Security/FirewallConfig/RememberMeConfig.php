...
class RememberMeConfig
{
     ...
     * @default NULL
     */
    public function setTokenProvider( $value): self
    {
    ...
    public function addUserProvider( $value): self
    {
     ...
     * @default true
     */
    public function setCatchExceptions(bool $value): self
    {
     ...
     */
    public function setSecure(string $value): self
    {
        $this->secure = $value;
     ...
     * @default true
     */
    public function setHttponly(bool $value): self
    {
        $this->httponly = $value;
     ...
     * @default false
     */
    public function setAlwaysRememberMe(bool $value): self
    {
     ...
     */
    public function setRememberMeParameter( $value): self
    {
