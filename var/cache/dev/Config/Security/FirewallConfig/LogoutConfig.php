...
class LogoutConfig
{
     ...
     * @default '/'
     */
    public function setTarget( $value): self
    {
        $this->target = $value;
     ...
     * @default true
     */
    public function setInvalidateSession(bool $value): self
    {
    ...
    public function addDeleteCookie(string $name, array $value = []): \Config\Security\FirewallConfig\LogoutConfig\DeleteCookieConfig
    {
        return $this->deleteCookies[$name] = new \Config\Security\FirewallConfig\LogoutConfig\DeleteCookieConfig($value);
    }
    
    public function addHandler( $value): self
    {
        $this->handlers[] = $value;
