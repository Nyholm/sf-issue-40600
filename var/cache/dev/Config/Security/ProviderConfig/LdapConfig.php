...
class LdapConfig
{
     ...
     * @default NULL
     */
    public function setBaseDn( $value): self
    {
        $this->baseDn = $value;
    ...
    public function addExtraField( $value): self
    {
    ...
    public function addDefaultRole( $value): self
    {
     ...
     */
    public function setUidKey( $value): self
    {
        $this->uidKey = $value;
     ...
     */
    public function setFilter( $value): self
    {
        $this->filter = $value;
